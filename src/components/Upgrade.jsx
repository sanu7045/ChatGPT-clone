...
function Upgrade() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-50/50">
      <div className="w-[450px] bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 flex flex-col gap-8">
        {['plus', 'chatgpt'].map((id) => (
          <div key={id} className="flex justify-between items-center group">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <p className="text-xl font-medium text-gray-900">{id === 'plus' ? 'ChatGPT Plus' : 'ChatGPT'}</p>
